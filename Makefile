...
$(TARGET): $(KERNEL_DIR_ASSEMS_OBJS) $(RISCV32_DIR_ASSEMS_OBJS) $(KERNEL_DIR_SRCS_OBJS) $(RISCV32_DIR_SRCS_OBJS)
	$(CC) $(CFLAGS) -Wl,-T$(LINKER_DIR)/kernel.ld -Wl,-Map=$(LINKER_DIR)/kernel.map -o $(TARGET) $(KERNEL_DIR_ASSEMS_OBJS) $(RISCV32_DIR_ASSEMS_OBJS) $(KERNEL_DIR_SRCS_OBJS) $(RISCV32_DIR_SRCS_OBJS)
